      ...
      <div className="px-6 md:px-16 lg:px-24 max-w-3xl mx-auto w-full flex flex-col gap-0">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {["Product language", "Information architecture", "Evidence-driven naming", "Ontology & conceptual modeling", "Workshop design", "Cross-functional facilitation", "UX writing", "Change management"].map((skill) => (
              <span key={skill} className="bg-foreground/8 border border-border/50 rounded-full px-4 py-2 text-sm font-medium text-foreground/80">
                {skill}
              </span>
            ))}
          </div>
