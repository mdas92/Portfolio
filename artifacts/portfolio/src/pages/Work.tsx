  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="group flex flex-col rounded-xl border border-border bg-background hover:border-primary/40 hover:bg-muted/40 transition-all cursor-pointer overflow-hidden"
      >
        {/* Visual thumbnail */}
        <div className="w-full aspect-[16/9] overflow-hidden border-b border-border bg-muted flex items-center justify-center">
