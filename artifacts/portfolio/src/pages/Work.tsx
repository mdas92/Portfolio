    ...
    <div className="flex-1 flex flex-col w-full bg-background">
      <div className="px-6 md:px-14 py-12 md:py-20 max-w-6xl mx-auto w-full">
        ...
        <div className="mt-16 pt-10 border-t border-border/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <p className="text-base font-sans text-foreground/60 leading-relaxed max-w-md">If you'd like to see more of the work I've done over the past 12 years of my career, find me at mohanadas.dsi@gmail.com</p>
          <a
