...
export const projects: Project[] = [
  ...
  },
  {
    ...
    quoteAttribution: "Director of Lifecycle at Monday.com (prospect), on the map-led POC deck",
    ...
    sections: [
      ...
      },
      {
        ...
        content: "To turn a personal skill into a company capability, I authored a step-by-step Notion guide, then designed and ran a company-wide Content Map Challenge: ~15 participants, each assigned a real customer or prospect, two-week window, with individualized written feedback on every single map.",
        bullets: [
      ...
      },
      {
        heading: "Outcomes",
        bullets: [
          "**Commercial:** credited as a key session in the $90K Mintos closed-won deal. A prospect called the map-led deck \"the selling point of the session.\"",
          ...
          "**Organizational:** ~15 people across every function built full end-to-end maps; proposed as a 60-day certification for all new hires.",
          "**Technical:** map templates became training data for ContentMaPT and MapPT, and a repeatable Content Map + aamPT onboarding workflow.",
          "**Public:** authored the company's definitive blog on the concept, followed by Message Structures (Jan 2026) extending the thinking.",
        ],
      },
      {
        heading: "Challenges",
